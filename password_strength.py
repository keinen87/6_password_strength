...
def get_password_strength(password):
    ...
    min_length_bound = 5
    max_lenght_bound = 8
    if is_password_in_blacklist(password, load_blacklist_file(filepath)) or \
...
if __name__ == '__main__':
    ...
    print('Password strength: {0}'.format(get_password_strength(password)))
